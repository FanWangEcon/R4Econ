...
### [Section 1.4 Regular Expression, Date, etc.][Regular Expression, Date, etc.] links
...
## Manipulate and Summarize Dataframes links

### [Section 2.1 Variables in Dataframes][Variables in Dataframes] links
...
### [Section 2.2 Counting Observation][Counting Observation] links
...
### [Section 2.3 Sorting, Indexing, Slicing][Sorting, Indexing, Slicing] links
...
### [Section 2.4 Advanced Group Aggregation][Advanced Group Aggregation] links
...
### [Section 2.5 Distributional Statistics][Distributional Statistics] links
...
### [Section 2.6 Summarize Multiple Variables][Summarize Multiple Variables] links
...
### [Section 4.4 Join and Merge Files Together by Keys][Join and Merge Files Together by Keys] links
...
## Coding and Development links

### [Section 12.1 Installation and Packages][Installation and Packages] links
...
### [Section 12.5 Run Code in Parallel in R][Run Code in Parallel in R] links
