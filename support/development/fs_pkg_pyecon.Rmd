---
title: "pyecon Refreshes Package, Generates RMD based PDF, HTML and R Files"
...
pyecon Rmd to PDF and HTML.

```{r}
# file_path_root <- 'C:/Users/fan/pyecon/support/development/fs_pkg_pyecon'
...
Check through *pyecon* and see which files have been added, and which files have been modified. bl_test set to TRUE. Not generating any new files, just checking.
...
```{python}
import pyecon.util.rmd.bookdownparse as ft_bookdownparse

# Path Roots
sfc_prj = 'pyecon'
sph_prj = 'C:/Users/fan/pyecon/'
