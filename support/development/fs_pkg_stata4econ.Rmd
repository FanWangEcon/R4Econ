...
#### Installation of StataMarkdown

```{r}
# https://www.ssc.wisc.edu/~hemken/Stataworkshops/Stata%20and%20R%20Markdown/StataMarkdown.html
...
```
file:///G:/repos/Stata4econ/bookdown/index.html
```
...
# run examples
spt_root_pf <- 'G:/repos/Stata4Econ'
spt_log <- 'G:/repos/Stata4Econ/_log/rmdclean/'
...
ff_sup_clean_rmd(ar_spt_root = spt_root_pf,
