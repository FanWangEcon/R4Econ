---
title: "Stat4Econ Refreshes Package, Generates RMD based PDF, HTML and R Files"
...
Stat4Econ Rmd to PDF and HTML.

```{r}
# file_path_root <- 'G:/repos/Stat4Econ/support/development/fs_pkg_Stat4Econ'
...
```
file://G:/repos/Stat4Econ/bookdown/index.html
file://G:/repos/Stat4Econ/probability/
```

#### Testing Which Files Have Changed

Check through *Stat4Econ* and see which files have been added, and which files have been modified. bl_test set to TRUE. Not generating any new files, just checking.

Note: new files that should not get pdf and html should have *.rmd* rather than *.Rmd* as suffix.

```{r}
# run examples
spt_root <- 'G:/repos/Stat4Econ'
spt_log <- 'G:/repos/Stat4Econ/_log/rmdclean/'
...
ff_sup_clean_rmd(ar_spt_root = c('G:/repos/Stat4Econ/'),
                 ar_spn_skip = c('support', 'index.Rmd', 'README',
                                 'main.Rmd', '_mod.Rmd', 'title.Rmd',
                                 'hypothesis', 'tidyverse.Rmd'),
