...
\hypertarget{load-data-in-from-stata}{%
\section{Load Data in from Stata}\label{load-data-in-from-stata}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df_iris <-}\StringTok{ }\KeywordTok{read_dta}\NormalTok{(}\StringTok{"../../_data/iris.dta"}\NormalTok{)}
\NormalTok{tb_iris <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(df_iris)}
