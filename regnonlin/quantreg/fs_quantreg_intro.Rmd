...
#### Estimate Mean and Conditional Quantile Coefficients using mtcars dataset

Here, we conduct tests for using the [quantreg](https://cran.r-project.org/web/packages/quantreg/index.html) package, using the built-in [mtcars](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/mtcars.html) dataset.
...
#### Test Conditional Quantile Coefficients if Different
...
##### Test Statistical Difference between 25th and 50th Conditional Quantiles
...
##### Test Statistical Difference between 25th, 50th, and 75th Conditional Quantiles
