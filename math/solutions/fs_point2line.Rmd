...
We first have $X_1$ an $Y_1$, given these, we are able to generate $R =\frac{X_2}{Y_2}$, a ratio. We want to iteratively update $X_1$ and $X_2$, but we only know the ratio. Think of $R$ as a line through the origin with $R$ as the slope.
...
1. The slope of the diagonal line is $-\frac{Y_2}{X_2}=-\frac{1}{R}$
