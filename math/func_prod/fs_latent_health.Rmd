...
#### Single Contemporaneous Input Model New
...
Maximizer $\widehat{\rho}$ is an individual-specific maximizer. Not entirely clear if $\widehat{\rho}^{\ast}=\rho$, that is, not clear if the procedure above identifies the true $\rho$.
