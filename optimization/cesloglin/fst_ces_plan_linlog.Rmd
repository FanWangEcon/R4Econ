...
```{r Optimal Linear Allocation Hard Code}
...
### Optimal Linear Allocation Solved using Function and DPLYR

```{r Optimal Linear Allocation Equation Line by Line Test}
...
for (it_ctr in seq(1, 10)) {
  ...
  fl_N_agg = sum(df_hw_cebu_m24$prot)
