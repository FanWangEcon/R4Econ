...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{st_tex_text <-}\StringTok{ "}\CharTok{\textbackslash{}n}\StringTok{% Lat2ex Comments}\CharTok{\textbackslash{}n\textbackslash{}\textbackslash{}}\StringTok{newcommand\{}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{exa\}\{}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{text\{from external file: \} }\CharTok{\textbackslash{}\textbackslash{}}\StringTok{alpha + }\CharTok{\textbackslash{}\textbackslash{}}\StringTok{beta\}}\CharTok{\textbackslash{}n}\StringTok{% More LaLatex Comments}\CharTok{\textbackslash{}n}\StringTok{"}
\NormalTok{st_clean_a1 <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{%.*?}\CharTok{\textbackslash{}\textbackslash{}\textbackslash{}n}\StringTok{"}\NormalTok{, }\StringTok{""}\NormalTok{, st_tex_text)}
\NormalTok{st_clean_a2 <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"L.*?x"}\NormalTok{, }\StringTok{"[LATEX]"}\NormalTok{, st_tex_text)}
\KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{'st_tex_text:'}\NormalTok{, st_tex_text))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{st_tex_text <-}\StringTok{ "}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{end\{equation\}}\CharTok{\textbackslash{}n}\StringTok{\}}\CharTok{\textbackslash{}n}\StringTok{% Even more comments from Latex preamble"}
\NormalTok{st_clean_a1 <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}\textbackslash{}n}\StringTok{%.*"}\NormalTok{,}\StringTok{""}\NormalTok{, st_tex_text)}
\KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{'st_tex_text:'}\NormalTok{, st_tex_text))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{it_N_child_cnt =}\StringTok{ }\DecValTok{2}
...
\NormalTok{fl_rho =}\StringTok{ }\FloatTok{0.1}
\NormalTok{fl_lambda =}\StringTok{ }\FloatTok{1.1}
\NormalTok{mt_nP_A_alpha =}\StringTok{ }\KeywordTok{cbind}\NormalTok{(ar_nN_A, ar_nN_alpha, fl_rho, fl_lambda)}
\NormalTok{ar_st_varnames <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'s_A'}\NormalTok{, }\StringTok{'s_alpha'}\NormalTok{, }\StringTok{'p_rho'}\NormalTok{, }\StringTok{'p_lambda'}\NormalTok{)}
\NormalTok{tb_states_endo <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(mt_nP_A_alpha) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename_all}\NormalTok{(}\OperatorTok{~}\KeywordTok{c}\NormalTok{(ar_st_varnames)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rowid_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"state_id"}\NormalTok{) }
...
\NormalTok{ar_nN_d =}\StringTok{ }\KeywordTok{seq}\NormalTok{(fl_min, fl_max, }\DataTypeTok{length.out =}\NormalTok{ it_N_choice_cnt)}
\NormalTok{ar_st_varnames <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'c_food'}\NormalTok{)}
\NormalTok{tb_choices <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(ar_nN_d) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename_all}\NormalTok{(}\OperatorTok{~}\KeywordTok{c}\NormalTok{(ar_st_varnames)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rowid_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"choice_id"}\NormalTok{) }

\CommentTok{# C. Shock Grid}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{it_N_shock_cnt =}\StringTok{ }\DecValTok{4}
\NormalTok{ar_nQ_shocks =}\StringTok{ }\KeywordTok{exp}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(it_N_shock_cnt, }\DataTypeTok{mean=}\DecValTok{0}\NormalTok{, }\DataTypeTok{sd=}\DecValTok{1}\NormalTok{))}
\NormalTok{ar_st_varnames <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'s_eps'}\NormalTok{)}
\NormalTok{tb_states_exo <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(ar_nQ_shocks) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename_all}\NormalTok{(}\OperatorTok{~}\KeywordTok{c}\NormalTok{(ar_st_varnames)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rowid_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"shock_id"}\NormalTok{) }

\CommentTok{# dataframe expand with other non expanded variables}
\NormalTok{ar_st_varnames <-}\StringTok{ }
\NormalTok{tb_states_shk_choices <-}\StringTok{ }\NormalTok{tb_states_endo }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{expand_grid}\NormalTok{(tb_choices) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{expand_grid}\NormalTok{(tb_states_exo) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(state_id, choice_id, shock_id, }
\NormalTok{         s_A, s_alpha, s_eps, c_food,}
\NormalTok{         p_rho, p_lambda)}
  
\CommentTok{# display}
\KeywordTok{kable}\NormalTok{(tb_states_shk_choices) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable_styling_fc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{expand_grid}\NormalTok{(}\DataTypeTok{x =} \DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, }\DataTypeTok{y =} \DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{, }\DataTypeTok{z =} \DecValTok{-3}\OperatorTok{:-}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
\CommentTok{# case_when with mtcars}
\NormalTok{df_mtcars <-}\StringTok{ }\NormalTok{df_mtcars }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mpg_qsec_am_grp =} 
           \KeywordTok{case_when}\NormalTok{(mpg }\OperatorTok{<}\StringTok{ }\DecValTok{16} \OperatorTok{~}\StringTok{ "< 16 MPG"}\NormalTok{,}
\NormalTok{                     qsec }\OperatorTok{>=}\StringTok{ }\DecValTok{20} \OperatorTok{~}\StringTok{ "> 16 MPG & qsec >= 20"}\NormalTok{,}
\NormalTok{                     am }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{~}\StringTok{ "> 16 MPG & asec < 20 & manual"}\NormalTok{,}
                     \OtherTok{TRUE} \OperatorTok{~}\StringTok{ "Others"}\NormalTok{))}

\CommentTok{# # For dataframe}
\CommentTok{# df.reg <-df.reg %>% na_if(-Inf) %>% na_if(Inf)}
\CommentTok{# # For a specific variable in dataframe}
\CommentTok{# df.reg.use %>% mutate(!!(var.input) := na_if(!!sym(var.input), 0))}
\CommentTok{# }
\CommentTok{# # Setting to NA}
\CommentTok{# df.reg.use <- df.reg.guat %>% filter(!!sym(var.mth) != 0)}
\CommentTok{# df.reg.use.log <- df.reg.use}
...
\CommentTok{# df.reg.use.log[which(df.reg.use$prot.imputed.log==-Inf),] = NA}
\CommentTok{# df.reg.use.log <- df.reg.use.log %>% drop_na(prot.imputed.log)}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-40-1} \end{center}
...
\CommentTok{# NA_real_, NA_character_, NA_integer_, NA_complex_}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{2341}\NormalTok{)}
\NormalTok{df_mtcars <-}\StringTok{ }\NormalTok{df_mtcars }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mpg_wth_NA1 =} \KeywordTok{na_if}\NormalTok{(}
    \KeywordTok{case_when}\NormalTok{(}
      \KeywordTok{rnorm}\NormalTok{(}\KeywordTok{n}\NormalTok{(),}\DataTypeTok{mean=}\DecValTok{0}\NormalTok{,}\DataTypeTok{sd=}\DecValTok{1}\NormalTok{) }\OperatorTok{<}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ }\DecValTok{-999}\NormalTok{, }
      \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }\NormalTok{mpg), }
    \DecValTok{-999}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mpg_wth_NA2 =} \KeywordTok{case_when}\NormalTok{(}
    \KeywordTok{rnorm}\NormalTok{(}\KeywordTok{n}\NormalTok{(),}\DataTypeTok{mean=}\DecValTok{0}\NormalTok{,}\DataTypeTok{sd=}\DecValTok{1}\NormalTok{) }\OperatorTok{<}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ }\OtherTok{NA_real_}\NormalTok{, }
    \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }\NormalTok{mpg)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mpg_wth_NA3 =} \KeywordTok{case_when}\NormalTok{(}
    \KeywordTok{rnorm}\NormalTok{(}\KeywordTok{n}\NormalTok{(),}\DataTypeTok{mean=}\DecValTok{0}\NormalTok{,}\DataTypeTok{sd=}\DecValTok{1}\NormalTok{) }\OperatorTok{<}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ }\OtherTok{NA_character_}\NormalTok{, }
    \OtherTok{TRUE} \OperatorTok{~}\StringTok{ "shock > 0 string"}\NormalTok{))}
  
\CommentTok{# Generate New Variables based on if mpg_wth_NA is NA or not}
...
\NormalTok{df_mtcars <-}\StringTok{ }\NormalTok{df_mtcars }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{group_with_na =} 
           \KeywordTok{case_when}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(mpg_wth_NA2) }\OperatorTok{&}\StringTok{ }\KeywordTok{is.na}\NormalTok{(mpg_wth_NA3) }\OperatorTok{~}\StringTok{ }
\StringTok{                       "Rand String and Rand Numeric both NA"}\NormalTok{, }
\NormalTok{                     mpg }\OperatorTok{<}\StringTok{ }\DecValTok{16} \OperatorTok{~}\StringTok{ "< 16 MPG"}\NormalTok{,}
\NormalTok{                     qsec }\OperatorTok{>=}\StringTok{ }\DecValTok{20} \OperatorTok{~}\StringTok{ "> 16 MPG & qsec >= 20"}\NormalTok{,}
\NormalTok{                     am }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{~}\StringTok{ "> 16 MPG & asec < 20 & manual"}\NormalTok{,}
                     \OtherTok{TRUE} \OperatorTok{~}\StringTok{ "Fake String NA"}\NormalTok{))}

\CommentTok{# show}
\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(df_mtcars }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\KeywordTok{starts_with}\NormalTok{(}\StringTok{'mpg'}\NormalTok{)),}\DecValTok{13}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling_fc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-42-1} \end{center}
...
\NormalTok{tol_lvl =}\StringTok{ }\FloatTok{1.5e-3}
\NormalTok{sd_lower_than_tol =}\StringTok{ }\NormalTok{tol_lvl}\OperatorTok{/}\DecValTok{10}
\NormalTok{sd_higher_than_tol =}\StringTok{ }\NormalTok{tol_lvl}\OperatorTok{*}\DecValTok{10}

\CommentTok{# larger SD}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{mt_runif_standard <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DataTypeTok{mean=}\DecValTok{0}\NormalTok{,}\DataTypeTok{sd=}\NormalTok{sd_higher_than_tol), }\DataTypeTok{nrow=}\DecValTok{5}\NormalTok{, }\DataTypeTok{ncol=}\DecValTok{2}\NormalTok{)}

\CommentTok{# small SD}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{mt_rnorm_small_sd <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DataTypeTok{mean=}\DecValTok{0}\NormalTok{,}\DataTypeTok{sd=}\NormalTok{sd_lower_than_tol), }\DataTypeTok{nrow=}\DecValTok{5}\NormalTok{, }\DataTypeTok{ncol=}\DecValTok{2}\NormalTok{)}

\CommentTok{# Generates Random Matirx}
\NormalTok{tb_rnorm_runif <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(mt_rnorm_small_sd, mt_runif_standard))}

\CommentTok{# Are Variables the same, not for strict comparison}
\NormalTok{tb_rnorm_runif_approxi_same <-}\StringTok{ }\NormalTok{tb_rnorm_runif }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{V1_V2_ALMOST_SAME =} 
           \KeywordTok{case_when}\NormalTok{(}\KeywordTok{isTRUE}\NormalTok{(}\KeywordTok{all.equal}\NormalTok{(V1, V2, }\DataTypeTok{tolerance=}\NormalTok{tol_lvl)) }\OperatorTok{~}\StringTok{ }
\StringTok{                       }\KeywordTok{paste0}\NormalTok{(}\StringTok{'TOL='}\NormalTok{,sd_lower_than_tol,}\StringTok{', SAME ALMOST'}\NormalTok{),}
                     \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }
\StringTok{                       }\KeywordTok{paste0}\NormalTok{(}\StringTok{'TOL='}\NormalTok{,sd_lower_than_tol,}\StringTok{', NOT SAME ALMOST'}\NormalTok{))) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{V3_V4_ALMOST_SAME =}
           \KeywordTok{case_when}\NormalTok{(}\KeywordTok{isTRUE}\NormalTok{(}\KeywordTok{all.equal}\NormalTok{(V3, V4, }\DataTypeTok{tolerance=}\NormalTok{tol_lvl)) }\OperatorTok{~}\StringTok{ }
\StringTok{                       }\KeywordTok{paste0}\NormalTok{(}\StringTok{'TOL='}\NormalTok{,sd_higher_than_tol,}\StringTok{', SAME ALMOST'}\NormalTok{),}
                     \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }
\StringTok{                       }\KeywordTok{paste0}\NormalTok{(}\StringTok{'TOL='}\NormalTok{,sd_higher_than_tol,}\StringTok{', NOT SAME ALMOST'}\NormalTok{)))}

\CommentTok{# Pring}
\KeywordTok{kable}\NormalTok{(tb_rnorm_runif_approxi_same) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable_styling_fc_wide}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(}\StringTok{"bridex.B"} \OperatorTok{%in%}\StringTok{ }\NormalTok{(df.reg.out.all}\OperatorTok{$}\NormalTok{vars_var.y))}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-80-1} \end{center}
...
\StringTok{        }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =}\NormalTok{ st_title,}
             \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
             \DataTypeTok{x =}\NormalTok{ st_x_label,}
             \DataTypeTok{y =}\NormalTok{ st_y_label,}
             \DataTypeTok{caption =}\NormalTok{ st_caption)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df.use <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(S.country }\OperatorTok{==}\StringTok{ 'Guatemala'}\NormalTok{) }\OperatorTok{%>%}
...
\NormalTok{df.coef <-}\StringTok{ }\NormalTok{df.reg.out[,}\KeywordTok{c}\NormalTok{(arr.columns2select)] }\OperatorTok{%>%}
...
\StringTok{                        }\KeywordTok{filter}\NormalTok{(svymthRound }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{12}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{24}\NormalTok{)) }\OperatorTok{%>%}
...
\NormalTok{    df.decompose_step3 <-}\StringTok{ }\NormalTok{df.decompose_step3 }\OperatorTok{%>%}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-150-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-154-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-154-2} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-154-3} \end{center}
...
\CommentTok{# P fixed parameters, nN is N dimensional, nP is P dimensional}
\NormalTok{ar_nN_A =}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\OperatorTok{-}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DataTypeTok{length.out =} \DecValTok{4}\NormalTok{)}
\NormalTok{ar_nN_alpha =}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\DataTypeTok{length.out =} \DecValTok{4}\NormalTok{)}
...
\CommentTok{# Mesh Expand}
\NormalTok{tb_states_choices <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(ar_nN_A, ar_nN_alpha)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rowid_to_column}\NormalTok{(}\DataTypeTok{var=}\NormalTok{svr_id_var)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(}\KeywordTok{t}\NormalTok{(tb_states_choices_bisec), }\DecValTok{25}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{kable_styling_fc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(tb_states_choices_bisec_long }\OperatorTok{%>%}\StringTok{ }
\StringTok{             }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{one_of}\NormalTok{(}\StringTok{'p'}\NormalTok{,}\StringTok{'f_p'}\NormalTok{,}\StringTok{'f_p_t_f_a'}\NormalTok{)), }\DecValTok{15}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{kable_styling_fc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{kable}\NormalTok{(}\KeywordTok{tail}\NormalTok{(tb_states_choices_bisec_long }\OperatorTok{%>%}\StringTok{ }
\StringTok{             }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{one_of}\NormalTok{(}\StringTok{'p'}\NormalTok{,}\StringTok{'f_p'}\NormalTok{,}\StringTok{'f_p_t_f_a'}\NormalTok{)), }\DecValTok{15}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{kable_styling_fc}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(tb_states_choices_bisec_wider }\OperatorTok{%>%}\StringTok{ }
\StringTok{              }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{one_of}\NormalTok{(}\StringTok{'p'}\NormalTok{,}\StringTok{'f_p'}\NormalTok{,}\StringTok{'f_p_t_f_a'}\NormalTok{)), }\DecValTok{10}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{kable_styling_fc_wide}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!!}\KeywordTok{sym}\NormalTok{(svr_abfafb_long_name) }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'a'}\NormalTok{, }\StringTok{'b'}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Sample Mean '}\NormalTok{, slb_title_shr),}
       \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
       \DataTypeTok{x =}\NormalTok{ slb_xtitle,}
       \DataTypeTok{y =} \StringTok{'Sample Mean'}\NormalTok{,}
       \DataTypeTok{caption =} \StringTok{'Mean of Sample Integrates to True Mean'}\NormalTok{) }\OperatorTok{+}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-162-1} \end{center}
...
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size=}\FloatTok{0.75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Sample Standard Deviation '}\NormalTok{, slb_title_shr),}
       \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
       \DataTypeTok{x =}\NormalTok{ slb_xtitle,}
       \DataTypeTok{y =} \StringTok{'Sample Standard Deviation'}\NormalTok{,}
       \DataTypeTok{caption =} \StringTok{'Standard Deviation of Sample Integrates to True SD'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{trans=}\StringTok{'log10'}\NormalTok{, }\DataTypeTok{labels =}\NormalTok{ x.labels, }\DataTypeTok{breaks =}\NormalTok{ x.breaks) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-162-2} \end{center}
...
\CommentTok{# Shared Labels}
\NormalTok{slb_title_shr =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'as Uneven Rectangle Count Increases}\CharTok{\textbackslash{}n}\StringTok{'}\NormalTok{,}
                       \StringTok{'True Mean='}\NormalTok{, fl_eps_mean,}\StringTok{', sd='}\NormalTok{,fl_eps_sd)}
\NormalTok{slb_xtitle =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'Number of Quantile Bins for Uneven Rectangles Approximation'}\NormalTok{)}

\CommentTok{# Graph Results--Draw}
\NormalTok{plt_mean <-}\StringTok{ }\NormalTok{tb_sample_means }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{draw_count, }\DataTypeTok{y=}\NormalTok{mean)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size=}\FloatTok{0.75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Average '}\NormalTok{, slb_title_shr),}
       \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
       \DataTypeTok{x =}\NormalTok{ slb_xtitle,}
       \DataTypeTok{y =} \StringTok{'Approximated Mean'}\NormalTok{,}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-163-1} \end{center}
...
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{draw_count, }\DataTypeTok{y=}\NormalTok{sd)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size=}\FloatTok{0.75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Standard Deviation '}\NormalTok{, slb_title_shr),}
       \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
       \DataTypeTok{x =}\NormalTok{ slb_xtitle,}
       \DataTypeTok{y =} \StringTok{'Approximated Standard Deviation'}\NormalTok{,}
       \DataTypeTok{caption =} \StringTok{'Integral Approximation as Uneven Rectangle Count Increases'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{trans=}\StringTok{'log10'}\NormalTok{, }\DataTypeTok{labels =}\NormalTok{ x.labels, }\DataTypeTok{breaks =}\NormalTok{ x.breaks) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
\KeywordTok{print}\NormalTok{(plt_sd)}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-163-2} \end{center}
...
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size=}\FloatTok{0.75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Aggregate Probability '}\NormalTok{, slb_title_shr),}
       \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
       \DataTypeTok{x =}\NormalTok{ slb_xtitle,}
       \DataTypeTok{y =} \StringTok{'Sum of Uneven Rectangles'}\NormalTok{,}
       \DataTypeTok{caption =} \StringTok{'Sum of Approx. Probability as Uneven Rectangle Count Increases'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{trans=}\StringTok{'log10'}\NormalTok{, }\DataTypeTok{labels =}\NormalTok{ x.labels, }\DataTypeTok{breaks =}\NormalTok{ x.breaks) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-163-3} \end{center}
...
\CommentTok{# Shared Labels}
\NormalTok{slb_title_shr =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'as Even Rectangle Count Increases}\CharTok{\textbackslash{}n}\StringTok{'}\NormalTok{,}
                       \StringTok{'True Mean='}\NormalTok{, fl_eps_mean,}\StringTok{', sd='}\NormalTok{,fl_eps_sd)}
\NormalTok{slb_xtitle =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'Number Equi-distance Rectangles Bins'}\NormalTok{)}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Average '}\NormalTok{, slb_title_shr),}
       ...
       \DataTypeTok{caption =} \StringTok{'Integral Approximation as Even Rectangle width decreases'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{trans=}\StringTok{'log10'}\NormalTok{, }\DataTypeTok{labels =}\NormalTok{ x.labels, }\DataTypeTok{breaks =}\NormalTok{ x.breaks) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
\KeywordTok{print}\NormalTok{(plt_mean)}
\end{Highlighting}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-164-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-164-2} \end{center}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'Aggregate Probability '}\NormalTok{, slb_title_shr),}
       \DataTypeTok{subtitle =}\NormalTok{ st_subtitle,}
       \DataTypeTok{x =}\NormalTok{ slb_xtitle,}
       \DataTypeTok{y =} \StringTok{'Sum of Equi-Dist Rectangles'}\NormalTok{,}
       \DataTypeTok{caption =} \StringTok{'Sum of Approx. Probability as Equi-Dist Rectangle width decreases'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{trans=}\StringTok{'log10'}\NormalTok{, }\DataTypeTok{labels =}\NormalTok{ x.labels, }\DataTypeTok{breaks =}\NormalTok{ x.breaks) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
\KeywordTok{print}\NormalTok{(plt_cdf)}
\end{Highlighting}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-164-3} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-172-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-174-1} \end{center}
