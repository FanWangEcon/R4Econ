...
\NormalTok{ls\_abc \textless{}{-}}\StringTok{ }\KeywordTok{vector}\NormalTok{(}\DataTypeTok{mode =} \StringTok{"list"}\NormalTok{, }\DataTypeTok{length =} \DecValTok{0}\NormalTok{)}
\CommentTok{\# Add Named Elements to List Sequentially}
\NormalTok{ls\_abc}\OperatorTok{$}\NormalTok{a =}\StringTok{ }\DecValTok{1}
\NormalTok{ls\_abc}\OperatorTok{$}\NormalTok{b =}\StringTok{ }\DecValTok{2}
\NormalTok{ls\_abc}\OperatorTok{$}\NormalTok{c =}\StringTok{ \textquotesingle{}abc}\CharTok{\textbackslash{}\textquotesingle{}}\StringTok{s third element\textquotesingle{}}
\CommentTok{\# Get all Names Added to List}
\NormalTok{ar\_st\_list\_names \textless{}{-}}\StringTok{ }\KeywordTok{names}\NormalTok{(ls\_abc)}
\CommentTok{\# Print list in a loop}
\KeywordTok{print}\NormalTok{(ls\_abc)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{st\_file\_wno\_suffix\_s \textless{}{-}}\StringTok{ }\NormalTok{tools}\OperatorTok{::}\KeywordTok{file\_path\_sans\_ext}\NormalTok{(}\KeywordTok{basename}\NormalTok{(st\_example))}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-46-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-48-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-86-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-87-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-173-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-173-2} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-173-3} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit\_mean \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(mpg }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{disp }\OperatorTok{+}\StringTok{ }\NormalTok{hp }\OperatorTok{+}\StringTok{ }\KeywordTok{factor}\NormalTok{(am) }\OperatorTok{+}\StringTok{ }\KeywordTok{factor}\NormalTok{(vs), }\DataTypeTok{data =}\NormalTok{ mtcars)}
\KeywordTok{summary}\NormalTok{(fit\_mean)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ls\_fl\_quantiles \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.25}\NormalTok{, }\FloatTok{0.50}\NormalTok{, }\FloatTok{0.75}\NormalTok{)}
\NormalTok{fit\_quantiles \textless{}{-}}\StringTok{ }\KeywordTok{rq}\NormalTok{(mpg }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{disp }\OperatorTok{+}\StringTok{ }\NormalTok{hp }\OperatorTok{+}\StringTok{ }\KeywordTok{factor}\NormalTok{(am),}
               \DataTypeTok{tau =}\NormalTok{ ls\_fl\_quantiles,}
               \DataTypeTok{data =}\NormalTok{ mtcars)}
\KeywordTok{summary}\NormalTok{(fit\_quantiles, }\DataTypeTok{se =} \StringTok{"boot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ls\_fl\_quantiles \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.25}\NormalTok{, }\FloatTok{0.50}\NormalTok{)}
\NormalTok{fit\_quantiles \textless{}{-}}\StringTok{ }\KeywordTok{rq}\NormalTok{(mpg }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{disp }\OperatorTok{+}\StringTok{ }\NormalTok{hp }\OperatorTok{+}\StringTok{ }\KeywordTok{factor}\NormalTok{(am),}
               \DataTypeTok{tau =}\NormalTok{ ls\_fl\_quantiles,}
               \DataTypeTok{data =}\NormalTok{ mtcars)}
\KeywordTok{anova}\NormalTok{(fit\_quantiles, }\DataTypeTok{test =} \StringTok{"Wald"}\NormalTok{, }\DataTypeTok{joint=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{anova}\NormalTok{(fit\_quantiles, }\DataTypeTok{test =} \StringTok{"Wald"}\NormalTok{, }\DataTypeTok{joint=}\OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-188-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-188-2} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-189-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-189-2} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-189-3} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-190-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-190-2} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-190-3} \end{center}
...
\begin{verbatim}
##  [1]    1.00000000    0.99369043    0.99250837    0.99110487    0.98943842    0.98745978
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-201-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-202-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-203-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-205-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-207-1} \end{center}
...
\begin{center}\includegraphics{Panel-Data-and-Optimization-with-R_files/figure-latex/unnamed-chunk-208-1} \end{center}
...
## [1] "A NEW FL: C:/Users/fan/R4Econ/development/python/fs_python_reticulate.Rmd"
## [1] "A NEW FL: C:/Users/fan/R4Econ/development/python/main.Rmd"
\end{verbatim}
...
\NormalTok{ar\_spt\_root =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}C:/Users/fan/R4Econ/amto/array/\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}C:/Users/fan/R4Econ/math/integration\textquotesingle{}}\NormalTok{)}
\NormalTok{bl\_recursive =}\StringTok{ }\OtherTok{TRUE}
\NormalTok{st\_rmd\_suffix\_pattern =}\StringTok{ "*.Rmd"}
\NormalTok{ar\_spn\_skip \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}basics\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}integrate\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}main\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}mesh\textquotesingle{}}\NormalTok{)}
\NormalTok{ls\_bool\_convert \textless{}{-}}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{bl\_pdf=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{bl\_html=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{bl\_R=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{spt\_out\_directory \textless{}{-}}\StringTok{ \textquotesingle{}C:/Users/fan/Downloads/\_data\textquotesingle{}}
\NormalTok{bl\_verbose \textless{}{-}}\StringTok{ }\OtherTok{TRUE}

\CommentTok{\# Get Path}
\NormalTok{ls\_sfls  \textless{}{-}}\StringTok{ }\KeywordTok{list.files}\NormalTok{(}\DataTypeTok{path=}\NormalTok{ar\_spt\_root,}
                       \DataTypeTok{recursive=}\NormalTok{bl\_recursive,}
                       \DataTypeTok{pattern=}\NormalTok{st\_rmd\_suffix\_pattern,}
                       \DataTypeTok{full.names=}\NormalTok{T)}

\CommentTok{\# Exclude Some Files given ar\_spn\_skip}
\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\KeywordTok{missing}\NormalTok{(ar\_spn\_skip)) \{}
\NormalTok{  ls\_sfls \textless{}{-}}\StringTok{ }\NormalTok{ls\_sfls[}\OperatorTok{!}\KeywordTok{grepl}\NormalTok{(}\KeywordTok{paste}\NormalTok{(ar\_spn\_skip, }\DataTypeTok{collapse =} \StringTok{"|"}\NormalTok{), ls\_sfls)]}
\NormalTok{\}}
...
\NormalTok{  spt\_file \textless{}{-}}\StringTok{ }\KeywordTok{dirname}\NormalTok{(spn\_file)}
\NormalTok{  sna\_file \textless{}{-}}\StringTok{ }\NormalTok{tools}\OperatorTok{::}\KeywordTok{file\_path\_sans\_ext}\NormalTok{(}\KeywordTok{basename}\NormalTok{(spn\_file))}

  \CommentTok{\# Output FIles}
\NormalTok{  spn\_file\_pdf \textless{}{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(spt\_file, sna\_file, }\StringTok{\textquotesingle{}.pdf\textquotesingle{}}\NormalTok{)}
\NormalTok{  spn\_file\_html \textless{}{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(spt\_file, sna\_file, }\StringTok{\textquotesingle{}.html\textquotesingle{}}\NormalTok{)}
\NormalTok{  spn\_file\_R \textless{}{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(spt\_file, sna\_file, }\StringTok{\textquotesingle{}.R\textquotesingle{}}\NormalTok{)}

  \CommentTok{\# render to PDF}
  \ControlFlowTok{if}\NormalTok{ (ls\_bool\_convert}\OperatorTok{$}\NormalTok{bl\_pdf) \{}
    \ControlFlowTok{if}\NormalTok{ (bl\_verbose) }\KeywordTok{message}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}spn\_file\_pdf:\textquotesingle{}}\NormalTok{,spn\_file\_pdf, }\StringTok{\textquotesingle{}, PDF started\textquotesingle{}}\NormalTok{))}
\NormalTok{    rmarkdown}\OperatorTok{::}\KeywordTok{render}\NormalTok{(spn\_file, }\DataTypeTok{output\_format=}\StringTok{\textquotesingle{}pdf\_document\textquotesingle{}}\NormalTok{,}
                      \DataTypeTok{output\_dir =}\NormalTok{ spt\_out\_directory, }\DataTypeTok{output\_file =}\NormalTok{ sna\_file)}
    \ControlFlowTok{if}\NormalTok{ (bl\_verbose) }\KeywordTok{message}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}spn\_file\_pdf:\textquotesingle{}}\NormalTok{,spn\_file\_pdf, }\StringTok{\textquotesingle{}, PDF finished\textquotesingle{}}\NormalTok{))}
\NormalTok{    spn\_pdf\_generated \textless{}{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(spt\_out\_directory, }\StringTok{\textquotesingle{}/\textquotesingle{}}\NormalTok{, spn\_file\_pdf)}
\NormalTok{  \}}

  \CommentTok{\# render to HTML}
  \ControlFlowTok{if}\NormalTok{ (ls\_bool\_convert}\OperatorTok{$}\NormalTok{bl\_html) \{}
    \ControlFlowTok{if}\NormalTok{ (bl\_verbose) }\KeywordTok{message}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}spth\_html:\textquotesingle{}}\NormalTok{,spn\_file\_html, }\StringTok{\textquotesingle{}, HTML started.\textquotesingle{}}\NormalTok{))}
\NormalTok{    rmarkdown}\OperatorTok{::}\KeywordTok{render}\NormalTok{(spn\_file, }\DataTypeTok{output\_format=}\StringTok{\textquotesingle{}html\_document\textquotesingle{}}\NormalTok{,}
                      \DataTypeTok{output\_dir =}\NormalTok{ spt\_out\_directory, }\DataTypeTok{output\_file =}\NormalTok{ sna\_file)}
    \ControlFlowTok{if}\NormalTok{ (bl\_verbose) }\KeywordTok{message}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}spth\_html:\textquotesingle{}}\NormalTok{,spn\_file\_html, }\StringTok{\textquotesingle{}, HTML finished.\textquotesingle{}}\NormalTok{))}
\NormalTok{    spn\_html\_generated \textless{}{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(spt\_out\_directory, }\StringTok{\textquotesingle{}/\textquotesingle{}}\NormalTok{, spn\_file\_html)}
\NormalTok{  \}}

  \CommentTok{\# purl to R}
  \ControlFlowTok{if}\NormalTok{ (ls\_bool\_convert}\OperatorTok{$}\NormalTok{bl\_R) \{}
    \ControlFlowTok{if}\NormalTok{ (bl\_verbose) }\KeywordTok{message}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}purl\_to:\textquotesingle{}}\NormalTok{, }\KeywordTok{paste0}\NormalTok{(spn\_file\_R, }\StringTok{".R"}\NormalTok{)))}
\NormalTok{    knitr}\OperatorTok{::}\KeywordTok{purl}\NormalTok{(spn\_file, }\DataTypeTok{output=}\KeywordTok{paste0}\NormalTok{(spt\_out\_directory, }\StringTok{\textquotesingle{}/\textquotesingle{}}\NormalTok{, sna\_file, }\StringTok{\textquotesingle{}.R\textquotesingle{}}\NormalTok{), }\DataTypeTok{documentation =} \DecValTok{1}\NormalTok{)}
\NormalTok{    spn\_R\_generated \textless{}{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(spt\_out\_directory, }\StringTok{\textquotesingle{}/\textquotesingle{}}\NormalTok{, sna\_file, }\StringTok{\textquotesingle{}.R\textquotesingle{}}\NormalTok{)}
\NormalTok{  \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{Sys.which}\NormalTok{(}\StringTok{\textquotesingle{}python\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{py\_config}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{use\_condaenv}\NormalTok{(}\StringTok{\textquotesingle{}wk\_pyfan\textquotesingle{}}\NormalTok{)}
\CommentTok{\# Sys.which(\textquotesingle{}python\textquotesingle{})}
\KeywordTok{py\_run\_string}\NormalTok{(}\StringTok{\textquotesingle{}print(1+1)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \item
    \textbf{r}: \emph{paste0() + sub() + gsub() + grepl() + sprintf() + tail() + strsplit() + basename() + dirname() + substring()}
  \end{itemize}
\item
...
\hypertarget{section-11.1-file-in-and-outfile-in-and-out-links}{%
\subsection{\texorpdfstring{\protect\hyperlink{file-in-and-out}{Section 11.1 File in and Out} links}{Section 11.1 File in and Out links}}\label{section-11.1-file-in-and-outfile-in-and-out-links}}
